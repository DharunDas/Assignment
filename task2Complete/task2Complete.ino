...
if (borderDetect == true){
  ...
  {
    Serial.print("A Wall Has Been Detected!  \f");
     motors.setSpeeds(0, 0);
     delay(500);
...
void scanRoom() {
  ...
  if (movement = ">")
  {
    turn_count_r++;
    digitalWrite(13, HIGH);
    Serial.print("This is room " + (String)turn_count_r);
  }
  else if (movement = "<")
  {
    turn_count_l++;
    digitalWrite(13, HIGH);
    Serial.print("This is room " + (String)turn_count_l);
  }
  else{
...
//  if (movement == '>')
//  {
//    Serial.print("This is room " + turn_count_r);
//  }
//  else if (movement == '<')
//  {
//    Serial.print("This is room " + turn_count_l);
//  }
//  else{
//    Serial.print("Complete");
//  }

  ...
  if (Serial.available() > 0)
  {
    ...
    switch (movement)
    {
      ...
      case 'o': motors.setSpeeds(0, 0);
        break;
        case 'f': 
        Serial.print("Currently there is  " + (String)objectsFound + " objects found so far in the search and resue mission! \f");
        break;
...
//  }
  ...
  if (sonar.ping_cm() <= 20 && sonar.ping_cm() > 0)
  {
    ...
    //      if(found == true)
    //      {
    Serial.print("An object is found in corridor " + (String)corridor_count + " \f");
    motors.setSpeeds(0, 0);
    delay(600);
    //Serial.print("Now there is  " + (String)objectsFound + " objects found so far \f");
  }
}
void scanRoom() {
...
void scanLeftRoom() {
  ...
  if (movement = '<')
  {
    turn_count_l++;
    digitalWrite(13, HIGH);
    Serial.print("This is room number " + (String)turn_count_l + " on the left hand side of the corridor" + (String)corridor_count + " \f");
  }
  else {
  ...
  for (int i = 0; i < 35; i++)
  {
    ...
    {
      Serial.print("No object is found on the left side of this room \f");
    }break;
    delay(50);
  }
  motors.setSpeeds(0, 0);
  ...
  for (int i = 0; i < 40; i++) {
    ...
    {
      Serial.print("No object is found on the right side of this room \f");
    }break;
    delay(50);
  }
  Serial.print(".");
...
void scanRightRoom()
{
  ...
  if (movement = '>')
  {
    turn_count_r++;
    //digitalWrite(13, HIGH);
    Serial.print("This is room number " + (String)turn_count_r + " on the right hand side of the corridor "+ (String)corridor_count + " \f");
  }
  else {
